...
class Student:
    ...
    def __init__(self,name,age):
        self.name=name
        self.age=age
        Student.class_year=self.class_year

Student1= Student("kalyan",22)
print(Student1.name)
print(Student.class_year)
print(f"the student name is {Student1.name} and he will be graduated on year{Student.class_year}")